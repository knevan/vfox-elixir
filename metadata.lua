...
--- Plugin homepage
PLUGIN.homepage = "https://github.com/knevan/vfox-elixir"
--- Plugin license, please choose a correct license according to your needs.
PLUGIN.license = "Apache 2.0"
--- Plugin description
PLUGIN.description =
"Elixir vfox plugin, support for managing multiple Elixir language versions in Windows & Uinx-like system."
...
NOTE:
 ...
 --]]
PLUGIN.minRuntimeVersion = "1.0.0"
--[[
NOTE:
 ...
 --]]
PLUGIN.manifestUrl = "https://github.com/knevan/vfox-elixir/releases/download/manifest/manifest.json"
