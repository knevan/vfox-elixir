...
function PLUGIN:PreInstall(ctx)
    ...
    if os.getenv("VFOX_ELIXIR_MIRROR") == "hex" then
        ...
        if RUNTIME.osType == "windows" then
            ...
            if string.match(elixir_version, "^main") then
                elixirUtils.check_version_existence("https://github.com/elixir-lang/elixir/releases/tag/" ..
                    elixir_version)
                download_url = "https://github.com/elixir-lang/elixir/archive/refs/tags/" .. elixir_version .. ".tar.gz"
            else
                elixirUtils.check_version_existence("https://github.com/elixir-lang/elixir/releases/tag/v" ..
                    elixir_version)
